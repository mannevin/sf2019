...
public class Constants {
    ...
    public static String getUberClientId(Activity activity) {
        return getManifestData(activity, "com.example.vmann.mapbox.demo.UBER_CLIENT_ID");
    }

    public static String getUberClientSecret(Activity activity) {
        return getManifestData(activity, "com.example.vmann.mapbox.demo.UBER_CLIENT_SECRET");
    }

    public static String getUberRedirectUrl(Activity activity) {
        return getManifestData(activity, "com.example.vmann.mapbox.demo.UBER_REDIRECT_URL");
    }
